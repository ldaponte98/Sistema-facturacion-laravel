...
<body>
    ...
    <table class="tabla_1" border="1" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td colspan="3" style="background-color: #7bf6087c; font-size:14px;">
        ...
        <tr>
            ...
            <td>
                <center>
                    <b>Hora</b>&nbsp;&nbsp;{{ date('h:m A', strtotime($factura->fecha)) }}&nbsp;&nbsp;<b>Día</b>&nbsp;&nbsp;{{ date('d', strtotime($factura->fecha)) }}
                </center>
            </td>
            <td>
                <center><b>Mes</b>&nbsp;&nbsp;{{ date('m', strtotime($factura->fecha)) }}</center>
            </td>
            <td>
                <center><b>Año</b>&nbsp;&nbsp;{{ date('Y', strtotime($factura->fecha)) }}</center>
            </td>
        </tr>
    </table>
    <table class="tabla_1" border="1" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="10" style="border-top: none; background-color: #7bf6087c">
                <center><b>FACTURADO A:</b></center>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="background-color: #7bf6087c">
                <center><b>ITEM</b></center>
            </td>
            <td style="background-color: #7bf6087c" colspan="2">
            ...
            <td style="background-color: #7bf6087c">
                <center><b>IVA</b></center>
            </td>
            <td style="background-color: #7bf6087c">
                <center><b>DESC</b></center>
            </td>
            <td style="background-color: #7bf6087c" colspan="2">
        ...
        @foreach ($factura->detalles as $detalle)
            ...
            <tr>
                ...
                <td style="text-align: right; padding-right: 5px;">
                    ${{ number_format($detalle->descuento_producto, 0, '.', '.') }}</td>
        ...
        <tr>
            ...
            <td colspan="3" style="background-color: #7bf6087c; "><b>SUBTOTAL:
                </b>${{ number_format($subtotal, 0, '.', '.') }}</td>
        </tr>
        @if ($factura->servicio_voluntario > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #7bf6087c;"><b>S. VOLUNTARIO:
                    </b>${{ number_format($factura->servicio_voluntario, 0, '.', '.') }}</td>
            </tr>
        @endif
        @if ($factura->domicilio > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #7bf6087c;"><b>DOMICILIO:
                    </b>${{ number_format($factura->domicilio, 0, '.', '.') }}</td>
            </tr>
        @endif
        <tr>
            <td colspan="7" style="border-bottom: none; border-top: none; border-bottom: none; font-size:8px;">
                <center></center>
            </td>
            <td colspan="3" style="border-bottom: none; background-color: #7bf6087c;"><b>IVA:
        ...
        @if ($factura->descuento > 0)
            <tr>
                <td colspan="7" style="border-bottom: none;  border-top: none;">&nbsp;</td>
                <td colspan="3" style="border-bottom: none; background-color: #7bf6087c;"><b>DESCUENTO:
                    </b>${{ number_format($factura->descuento, 0, '.', '.') }}</td>
            </tr>
        @endif
        ...
        <tr>
            ...
            <td colspan="3" style="border-bottom: none; background-color: #7bf6087c;"><b>TOTAL:
                </b>${{ number_format($factura->valor, 0, '.', '.') }}</td>
        </tr>
        <tr>
    ...
    @if (isset($btn_descargar))
        <center>
            <a href="{{ route('factura/imprimir', $factura->id_factura) }}"
