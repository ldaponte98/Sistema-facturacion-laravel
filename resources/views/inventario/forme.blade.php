                ...
                <div id="pay-invoice">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                         <div class="form-group">
                                            ...
                                            <input id="fecha" name="fecha" type="datetime-local" class="form-control" aria-required="true" required aria-invalid="false" value="2023-01-19 15:39:21">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                         <div class="form-group">
                        ...
                        <div class="row" oninput="calc()">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1"><b>pagado</b></label>
                                        <input name="totcom" id="totcom" type="number" class="form-control" aria-required="true" aria-invalid="false" value="0" >
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
...
<script>
        ...
        if (this.detalles.length <= 0) {
            ...
            this.detalles.forEach((item) => {
                tabla += `  <tr>
                                ...
                                <td><center>$${format(parseInt(item.precio))}</center></td>
                                <td><center>$${format(parseInt(item.precio * item.cantidad))}</center></td>
                                <td>
                                <center>
    ...
    function calc() {
        var a = document.getElementById("totcom").value;
        var b = document.getElementById("cantidad").value;
        
        var result = document.getElementById("precio");
