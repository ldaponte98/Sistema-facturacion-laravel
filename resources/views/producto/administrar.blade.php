...
@section('content')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Administrar productos</strong>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                                                        ...
                                                        <table class="table" id="table-productos-{{ $item->id_dominio }}">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>
                                                                        <center><b>Precio venta</b></center>
                                                                    </th>
                                                                    <th>
                                                                    ...
                                                                    <th>
                                                                        <center><b>Aplica inventario</b></center>
                                                                    </th>
                                                                    <th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($productos as $producto)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <center>%{{ $producto->iva }}</center>
                                                                        </td>
                                                                        <td>
                                                                            <center>
                                                                                {{ $producto->descontado == 1 ? 'Aplica' : 'No aplica' }}
                                                                            </center>
                                                                        </td>
                                                                        <td>
                                                                            <center>{{ $producto->get_estado() }}</center>
                                                                        </td>
                                                                        <td>
                                                                            <center>
                                                                                <a
                                                                                ...
                                                                                <a class="ml-3"
                                                                                    href="{{ route('producto/editar', $producto->id_producto) }}">Editar</a>
                                                                            </center>
                                                                        </td>
                                                                    </tr>
                                                                    @php $cont++; @endphp
    ...
    <script type="text/javascript">
        function exportar_excel() {
            tableToExcel('tabla_excel', 'Reporte de productos ')
        }
